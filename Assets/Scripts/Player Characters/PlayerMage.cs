...
public class PlayerMage : MonoBehaviour
{
    ...
    private void CreateHealthbar()
    {
        ...
        ClonHealthbar.GetComponent<Healthbar>().SetMaxHealth(VidaTotal);                                                                          // Actualiza constantemente la Healthbar con la vida actual del personaje                                                                          // Inicializa la Healthbar con la vida máxima del personaje
